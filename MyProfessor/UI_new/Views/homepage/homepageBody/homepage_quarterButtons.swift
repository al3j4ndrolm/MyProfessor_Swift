...
let selectedColour = Color(red: 0.83, green: 1, blue: 0.64)
...
struct homepage_quarterButtons: View {
    ...
    private var buttonFirstQuarterBody: some View {
        Text(quarterText[0])
            ...
            .background(RoundedRectangle(cornerRadius: 32).fill(selectedFirstQuarter ? selectedColour : unselectedColour))
    }
